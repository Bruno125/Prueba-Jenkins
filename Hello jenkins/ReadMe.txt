========================================================================
    APLICACIÓN: Hello jenkins Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Hello jenkins.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Hello jenkins.

Hello jenkins.vcxproj
